 ...
 */
template AgeClaim(schemaVersion) {
    // --- private ---
    ...
    // Signature, expiry, range checks and the nullifier: claim type 1 is age.
    component base = CredentialClaimBase(schemaVersion, 1);
...
component main {
    public [issuerAx, issuerAy, currentDate, minimumAge, contextId, subject]
} = AgeClaim(1);
